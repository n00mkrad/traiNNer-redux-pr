...
class DatasetOptions(StrictStruct):
    ...
    lq_size: Annotated[
        ...
        Meta(
            description="During training, a crop of this size is taken from LR images. Use a single int for square crops or [height, width] for rectangular crops. Larger is usually better but uses more VRAM. Previously gt_size, use lq_size = gt_size / scale to convert. Use multiples of 8 for best performance with AMP."
        ),
    ] = None
