...
def _to_patch_hw(patch_size: int | tuple[int, int]) -> tuple[int, int]:
...
def paired_random_crop_vips(
    ...
    img_lq_np = single_crop_vips(img_lq, (lq_patch_h, lq_patch_w), x, y, lq_path)
    img_gt_np = single_crop_vips(img_gt, (gt_patch_h, gt_patch_w), x * scale, y * scale, gt_path)
